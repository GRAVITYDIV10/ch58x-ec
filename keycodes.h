...
#define KEY_MOD_LEFT_CTRL   (1 << 0)
#define KEY_MOD_LEFT_SHIFT  (1 << 1)
#define KEY_MOD_LEFT_ALT    (1 << 2)
#define KEY_MOD_LEFT_GUI    (1 << 3)
#define KEY_MOD_RIGHT_CTRL  (1 << 4)
#define KEY_MOD_RIGHT_SHIFT (1 << 5)
#define KEY_MOD_RIGHT_ALT   (1 << 6)
#define KEY_MOD_RIGHT_GUI   (1 << 7)
