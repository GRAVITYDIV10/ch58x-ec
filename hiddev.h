...
#define HID_KEY_MOD_LEFT_CTRL   (1 << 0)
#define HID_KEY_MOD_LEFT_SHIFT  (1 << 1)
#define HID_KEY_MOD_LEFT_ALT    (1 << 2)
#define HID_KEY_MOD_LEFT_GUI    (1 << 3)
#define HID_KEY_MOD_RIGHT_CTRL  (1 << 4)
#define HID_KEY_MOD_RIGHT_SHIFT (1 << 5)
#define HID_KEY_MOD_RIGHT_ALT   (1 << 6)
#define HID_KEY_MOD_RIGHT_GUI   (1 << 7)
...
#define HID_MOSUE_BTN_RIGHT  (1 << 1)
